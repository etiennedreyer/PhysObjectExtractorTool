...
cmssw-el6 --command-to-run \" cmsrel CMSSW_5_3_32; cd CMSSW_5_3_32/src; cmsenv; cd PhysObjectExtractorTool/PhysObjectExtractor/; source pbs/tmp/run_cms_${jobID}.sh \"